...
namespace Scripts
{
    public class Transition : MonoBehaviour
    {
        ...
        public static void LoadLevel(string level, float duration, [Bridge.Ref] Color color)
        {
        ...
        private void StartFade(string level, float duration, [Bridge.Ref] Color fadeColor)
        {
            StartCoroutine(RunFade(level, duration, fadeColor));
        }
        
        private IEnumerator RunFade(string level, float duration, [Bridge.Ref] Color fadeColor)
        {
